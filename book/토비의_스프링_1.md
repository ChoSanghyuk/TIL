...
<img src="토비의_스프링_1.assets/image-20230725075212743.png" alt="image-20230725075212743" style="zoom:75%;" />
...
인터페이스의 메소드 선언에는 없는 예외를 구현 클래스의 메소드의 throws에 넣을 수는 없다

모든 예외를 다 받아주는 `throws Exception`은 무책임한 선언

런타임 예외 사용 => `throws` 생략 => DB에 독립적인 메소드 정의
