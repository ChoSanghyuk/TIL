...
- 값 수정
  ...
  - Direct field access always modifies the struct itself 
  - Methods with value receivers operate on a copy of the struct, so changes don't persist. 
  - Methods with pointer receivers modify the actual struct. 
